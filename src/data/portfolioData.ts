...
export const RESUME_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      highlights: [
        'Designed and developed a modular Flask-based academic management platform with role-specific dashboards and workflows across attendance, QR attendance, assignments, announcements, leave management, student management, and academic operations.',
      ],
    },
    {
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    year: '2024 – 2025',
    shortDescription:
      'DeptSync is a role-based academic management system designed to digitize and centralize day-to-day departmental operations across attendance, assignments, announcements, and leave workflows.',
    description:
      'DeptSync is a role-based academic management system designed to digitize and centralize day-to-day departmental operations. It provides dedicated workflows for Administrators, Heads of Department (HODs), Staff, and Students, covering attendance, assignments, announcements, leave management, student registration, and academic activities.',
    technologies: [
      'Python',
      'Flask',
      'HTML5',
    ...
    images: [
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/landing-page.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/admin-dashboard.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/announcement.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/assignment-tracking.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/hod-dashboard.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/hod-attendance-analysis.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/student-attendance-dashboard.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/attendance-analytics.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/attendance-records.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/hod-approval.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/leave-approval.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/qr-code-generator.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/qr-scanning-attendance.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/staff-dashboard.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/staff-attendance-tracking.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/student-dashboard.png',
      'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/student-registration.png',
    ],
    gallery: [
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/landing-page.png',
        title: 'Landing Page',
        caption: 'Landing Page — Introduces the DeptSync platform and provides the entry point for users',
        altText: 'DeptSync Landing Page',
        fallbackUrls: [
      ...
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/admin-dashboard.png',
        title: 'Admin Dashboard',
        caption: 'Admin Dashboard — Centralized access to department management functions and system configuration',
        altText: 'DeptSync Admin Dashboard',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/admin-dashboard.png',
          '/screenshots/admin-dashboard.webp',
          '/screenshots/admin-dashboard.png',
          '/projects/deptsync/admin-dashboard.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/announcement.png',
        title: 'Announcement Management',
        caption: 'Announcement Management — Department-level information and updates communicated through role-targeted channels',
        altText: 'DeptSync Announcement Management',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/announcement.png',
          '/screenshots/announcement.webp',
          '/screenshots/announcement.png',
          '/projects/deptsync/announcement.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/assignment-tracking.png',
        title: 'Assignment Tracking',
        caption: 'Assignment Tracking — Academic assignment creation, viewing, submission, and status monitoring',
        altText: 'DeptSync Assignment Tracking',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/assignment-tracking.png',
          '/screenshots/assignment-tracking.webp',
          '/screenshots/assignment-tracking.png',
          '/projects/deptsync/assignment-tracking.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/hod-dashboard.png',
        title: 'HOD Dashboard',
        caption: 'HOD Dashboard — Department-level management covering announcements, attendance, assignments, leave, and student activities',
        altText: 'DeptSync HOD Dashboard',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/hod-dashboard.png',
          '/screenshots/hod-dashboard.webp',
          '/screenshots/hod-dashboard.png',
          '/projects/deptsync/hod-dashboard.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/hod-attendance-analysis.png',
        title: 'HOD Attendance Analysis',
        caption: 'HOD Attendance Analysis — In-depth attendance records review and analytics to support academic monitoring',
        altText: 'DeptSync HOD Attendance Analysis',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/hod-attendance-analysis.png',
          '/screenshots/hod-attendance-analysis.webp',
          '/screenshots/hod-attendance-analysis.png',
          '/projects/deptsync/hod-attendance-analysis.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/student-attendance-dashboard.png',
        title: 'Student Attendance Dashboard',
        caption: 'Student Attendance Dashboard — Personalized attendance-related information, subject tracking, and eligibility status',
        altText: 'DeptSync Student Attendance Dashboard',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/student-attendance-dashboard.png',
          '/screenshots/student-attendance-dashboard.webp',
          '/screenshots/student-attendance-dashboard.png',
          '/projects/deptsync/student-attendance-dashboard.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/attendance-analytics.png',
        title: 'Attendance Analytics',
        caption: 'Attendance Analytics — Visual attendance trends, date-wise tracking, charts, and departmental summary views',
        altText: 'DeptSync Attendance Analytics',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/attendance-analytics.png',
          '/screenshots/attendance-analytics.webp',
          '/screenshots/attendance-analytics.png',
          '/projects/deptsync/attendance-analytics.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/attendance-records.png',
        title: 'Attendance Records',
        caption: 'Attendance Records — Structured attendance log and historical record management across courses and batches',
        altText: 'DeptSync Attendance Records',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/attendance-records.png',
          '/screenshots/attendance-records.webp',
          '/screenshots/attendance-records.png',
          '/projects/deptsync/attendance-records.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/hod-approval.png',
        title: 'HOD Approval Workflow',
        caption: 'HOD Approval Workflow — Multi-level request review and verification for departmental approvals and registrations',
        altText: 'DeptSync HOD Approval Workflow',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/hod-approval.png',
          '/screenshots/hod-approval.webp',
          '/screenshots/hod-approval.png',
          '/projects/deptsync/hod-approval.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/leave-approval.png',
        title: 'Leave Approval and Rejection',
        caption: 'Leave Approval and Rejection — Role-based leave application review, status processing, and historical logs',
        altText: 'DeptSync Leave Approval and Rejection',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/leave-approval.png',
          '/screenshots/leave-approval.webp',
          '/screenshots/leave-approval.png',
          '/projects/deptsync/leave-approval.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/qr-code-generator.png',
        title: 'QR Code Generation',
        caption: 'QR Code Generation — Dynamic time-bounded QR code generation by staff for classroom attendance sessions',
        altText: 'DeptSync QR Code Generation',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/qr-code-generator.png',
          '/screenshots/qr-code-generator.webp',
          '/screenshots/qr-code-generator.png',
          '/projects/deptsync/qr-code-generator.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/qr-scanning-attendance.png',
        title: 'QR-Based Attendance',
        caption: 'QR-Based Attendance — Student QR scanning workflow for authenticated attendance marking',
        altText: 'DeptSync QR-Based Attendance',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/qr-scanning-attendance.png',
          '/screenshots/qr-scanning-attendance.webp',
          '/screenshots/qr-scanning-attendance.png',
          '/projects/deptsync/qr-scanning-attendance.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/staff-dashboard.png',
        title: 'Staff Dashboard',
        caption: 'Staff Dashboard — Faculty workspace for managing course subjects, attendance sessions, and student assignments',
        altText: 'DeptSync Staff Dashboard',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/staff-dashboard.png',
          '/screenshots/staff-dashboard.webp',
          '/screenshots/staff-dashboard.png',
          '/projects/deptsync/staff-dashboard.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/staff-attendance-tracking.png',
        title: 'Staff Attendance Tracking',
        caption: 'Staff Attendance Tracking — Live session attendance monitoring, manual adjustments, and student presence logs',
        altText: 'DeptSync Staff Attendance Tracking',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/staff-attendance-tracking.png',
          '/screenshots/staff-attendance-tracking.webp',
          '/screenshots/staff-attendance-tracking.png',
          '/projects/deptsync/staff-attendance-tracking.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/student-dashboard.png',
        title: 'Student Dashboard',
        caption: 'Student Dashboard — Centralized student workspace for academic activities, coursework, and notifications',
        altText: 'DeptSync Student Dashboard',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/student-dashboard.png',
          '/screenshots/student-dashboard.webp',
          '/screenshots/student-dashboard.png',
          '/projects/deptsync/student-dashboard.png',
        ],
      },
      {
        url: 'https://raw.githubusercontent.com/cmkarthik2004/DeptSync/main/screenshots/student-registration.png',
        title: 'Student Registration',
        caption: 'Student Registration — Department onboarding and student profile registration with academic records management',
        altText: 'DeptSync Student Registration',
        fallbackUrls: [
          'https://cdn.jsdelivr.net/gh/cmkarthik2004/DeptSync@main/screenshots/student-registration.png',
          '/screenshots/student-registration.webp',
          '/screenshots/student-registration.png',
          '/projects/deptsync/student-registration.png',
        ],
      },
    ],
    features: [
      'Role-Based Access: Separate dashboards and functionality for Administrators, HODs, Staff, and Students',
      'QR-Based Attendance: QR code generation and QR-based attendance marking for student attendance',
      'Attendance Analytics: Attendance records, date-wise tracking, analysis, charts, and summary views',
      'Assignment Management: Assignment creation, viewing, submission, and tracking',
      'Leave Management: Leave application, processing, approval, rejection, and related workflows',
      'Announcements: Department-level announcements and information sharing',
      'Student Management: Student registration and academic information management',
      'OTP-Based Verification: Authentication and OTP-based verification workflows',
      'Academic Management: Department-level academic workflow coordination and activity monitoring',
    ],
    myContribution:
      'Designed and developed a modular Flask-based academic management platform with role-specific dashboards and workflows across attendance, QR attendance, assignments, announcements, leave management, student management, and academic operations.',
    result:
      'Centralized multiple departmental workflows into one academic management platform, reducing manual administrative effort and bringing attendance, assignments, announcements, leave processing, student management, and academic activities into a single system.',
    architecture: {
      frontend: 'HTML5 · CSS3 · JavaScript · Jinja Templates',
      backend: 'Modular Python + Flask Application',
      database: 'MySQL Relational Database',
      deployment: 'Modular Flask application with separate functional modules for Admin, HOD, Staff, Students, attendance, assignments, leave management, announcements, database operations, and supporting utilities',
    },
    metrics: [
      { label: 'Role-Based Access', value: 'Admin · HOD · Staff · Student' },
      { label: 'Attendance Tech', value: 'QR Code + OTP Verification' },
      { label: 'Architecture', value: 'Modular Flask + MySQL' },
    ],
    featured: false,
  },
  {
