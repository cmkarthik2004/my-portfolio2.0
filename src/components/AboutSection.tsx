...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="py-20 md:py-28 relative scroll-mt-20" aria-label="About and Approach">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-7 space-y-6 text-base sm:text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
            <p>
